      ...
      <div class="data-catcher">
        <div class="aqar-details" v-if="RenderDetails()">
          ...
          <div class="data-filed">
            ...
            <h3 class="data-value"> متر مربع</h3>
          </div>
...
export default {
  props: ['id'], // This makes the id parameter available as a prop
